...
import { StyleSheet, ScrollView, ActivityIndicator, View, Text, TouchableOpacity, RefreshControl } from 'react-native';
...
const DEMO_DATA = {
  ...
  stats: [
    { label: "Total Products", value: "25", icon: "cube", color: "#8B9DC3", trend: "+2 new" }, // Soft blue
    { label: "Total Sold", value: "11.9k", icon: "receipt", color: "#86BC7A", trend: "+15%" }, // Soft green
    { label: "Low Stock", value: "8", icon: "alert-circle", color: "#E8B86D", trend: "Urgent" }, // Soft amber
    { label: "Total Debt", value: "NLe 45.2k", icon: "alert-circle", color: "#D4888F", trend: "12 Clients" }, // Soft rose
  ],
  recentSales: [
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      >
        ...
        <HeroCard data={dashboardData?.revenue || DEMO_DATA.profit} />

        <StatsGrid stats={dashboardData?.stats || DEMO_DATA.stats} />

        <RecentSales data={dashboardData?.recentSales || DEMO_DATA.recentSales} />

        <WeeklyChart data={dashboardData?.weeklySales || DEMO_DATA.weeklySales} />
