  ...
  const renderHeader = () => (
    <View>
      ...
      <View style={styles.header}>
        <View>
          <Text style={[styles.headerTitle, { color: colors.foreground }]}>Debts</Text>
          ...
          <View style={styles.metricItem}>
            ...
            <Text style={styles.metricValue} numberOfLines={1} adjustsFontSizeToFit minimumScaleFactor={0.6}>
              {metricsData.totalAmount >= 1000000 
                ? `NLe ${(metricsData.totalAmount / 1000000).toFixed(1)}M`
                : metricsData.totalAmount >= 1000
                ? `NLe ${Math.floor(metricsData.totalAmount / 1000)}K`
